...
<template>
  <div class="container">
    ...
    <div class="profile-header">
      <img :src="userInfo.avatar || 'https://placekitten.com/100/100'" alt="用户头像" class="profile-avatar">
    ...
    <div class="profile-section" v-show="activeTab === 'settings'">
      ...
      <div class="settings-form">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-input" v-model="editForm.avatar" placeholder="请输入头像URL">
        </div>
